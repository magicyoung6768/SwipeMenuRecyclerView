...
public class ObservableRecyclerView extends RecyclerView implements ObserveScrollable {
    ...
    public boolean onTouchEvent(MotionEvent ev) {
        if (mConsumeAnimate && getItemAnimator() != null && getItemAnimator().isRunning()) {
            return true;
        }
        if (hasNoCallbacks()) {
    ...
    public void setConsumeAnimate(boolean consumeAnimate) {
        this.mConsumeAnimate = consumeAnimate;
    }
