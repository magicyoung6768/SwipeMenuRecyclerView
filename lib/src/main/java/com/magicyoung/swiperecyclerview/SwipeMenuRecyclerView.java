...
/**
 * 滑动展示Menu的RecyclerView版本<br/>
 * <li/>
 * 添加滑动Menu展示模式选择：<br/>
 * 1.SwipeMenuLayout.setSwipeEnable (true) 如android版手Q，menu跟随滑动 <br/>
 * 2.default 如iOS版手Q，menu不跟随滑动 <br/>
 * <li/>
 * 支持左滑与右滑抽屉展示方式  {@link #setSwipeDirection(int)} <br/>
 *
...
public class SwipeMenuRecyclerView extends ObservableRecyclerView {
            ...
            case MotionEvent.ACTION_DOWN:
                ...
                if (mTouchPosition != oldPos && mTouchView != null && mTouchView.isOpen()) {
                    if (mOnSwipeListener != null) {
                        if (mOnSwipeListener.shouldCloseMenu(oldPos, mTouchPosition)) {
                            handleTouch(ev);
                            return true;
                        }
                    } else {
    ...
    public interface OnSwipeListener {
        ...
        boolean shouldCloseMenu(int oldPosition, int newPosition);
    }
